                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-medium text-gray-800 mb-2">
                          {isJapanese ? '1. プロフィール設定' : '1. Profile Setup'}
                        </h4>
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 mb-2">
                          {isJapanese ? '2. ガイド募集への応募' : '2. Apply to Guide Jobs'}
                        </h4>
                        <p className="text-gray-700 ml-4">
                          {isJapanese
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 mb-2">
                          {isJapanese ? '3. リクエストの管理' : '3. Manage Requests'}
                        </h4>
                        <p className="text-gray-700 ml-4">
                          {isJapanese
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 mb-2">
                          {isJapanese ? '4. チャットでのやり取り' : '4. Chat Communication'}
                        </h4>
                        <p className="text-gray-700 ml-4">
                          {isJapanese
                ...
                <div className="space-y-6 pt-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 mb-2">
                          {isJapanese ? '2. ガイドの検索' : '2. Search for Guides'}
                        </h4>
                        <p className="text-gray-700 ml-4">
                          {isJapanese
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 mb-2">
                          {isJapanese ? '3. 募集投稿の作成' : '3. Create Job Postings'}
                        </h4>
                        <p className="text-gray-700 ml-4">
                          {isJapanese
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 mb-2">
                          {isJapanese ? '4. 応募の管理' : '4. Manage Applications'}
                        </h4>
                        <p className="text-gray-700 ml-4">
                          {isJapanese
              ...
              <div className="space-y-6 pt-6">
                <div>
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? 'Q. メール認証が完了しません' : 'Q. Email verification is not completing'}
                  </h3>
                  <p className="text-gray-700 ml-4">
                    {isJapanese
                ...
                <div>
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? 'Q. プロフィール情報を変更したい' : 'Q. I want to change my profile information'}
                  </h3>
                  <p className="text-gray-700 ml-4">
                    {isJapanese
                ...
                <div>
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? 'Q. マッチングが成立した後のキャンセルはできますか？' : 'Q. Can I cancel after matching is established?'}
                  </h3>
                  <p className="text-gray-700 ml-4">
                    {isJapanese
                ...
                <div>
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? 'Q. 料金の支払い方法は？' : 'Q. What are the payment methods?'}
                  </h3>
                  <p className="text-gray-700 ml-4">
                    {isJapanese
                ...
                <div>
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? 'Q. 不適切なユーザーを報告したい' : 'Q. I want to report inappropriate users'}
                  </h3>
                  <p className="text-gray-700 ml-4">
                    {isJapanese
                ...
                <div>
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? 'Q. パスワードを忘れてしまいました' : 'Q. I forgot my password'}
                  </h3>
                  <p className="text-gray-700 ml-4">
                    {isJapanese
          ...
          {isOpen('withdraw') && (
            <div className="px-6 pb-6 border-t bg-red-50">
              <div className="space-y-6 pt-6">
                ...
                <div>
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? '退会手続きについて' : 'About Withdrawal Procedure'}
                  </h3>
                ...
                <div className="bg-gray-50 border rounded-lg p-4">
                  <h3 className="font-medium text-gray-800 mb-2">
                    {isJapanese ? 'お困りのことがあれば' : 'If you have any issues'}
                  </h3>
